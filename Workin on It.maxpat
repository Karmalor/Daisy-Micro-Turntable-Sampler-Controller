...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 219.913042366504669, 502.086955666542053, 34.0, 22.0 ],
					"text" : "limi~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 44.0, 110.0, 1316.0, 41.0 ],
					"relative" : 1,
...
,
					"patching_rect" : [ 160.0, 225.0, 97.0, 23.0 ],
...
,
					"patching_rect" : [ 265.0, 225.0, 49.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 105.0, 379.0, 43.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 105.0, 285.0, 42.0, 23.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 255.0, 74.0, 23.0 ],
					"text" : "pack f 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 105.0, 225.0, 35.0, 23.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 160.0, 165.0, 62.0, 23.0 ],
					"text" : "t 0 f f f 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 105.0, 315.0, 72.0, 23.0 ],
					"text" : "play~ test"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 40.0, 65.0, 66.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 90.0, 113.5, 23.0 ],
					"text" : "info~ test"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 567.60869425535202, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 40.0, 143.0, 23.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 274.5, 340.0, 128.0, 340.0 ],
					"source" : [ "obj-85", 0 ]
				}
